...
public class MigrationHybrid_MIRROR_Post implements VmMigrationTechnique {
	private int migPointPolicy;

	public MigrationHybrid_MIRROR_Post(int migPointPolicy) {
		super();
